...
| **C-24** | Les chemins de redaction ne sont pas des `redact.paths` Pino valides | **Wildcards à ajouter** (`*.password`) — ticket EVT-011 | [`SPRINT_PLAN.md`](sprints/SPRINT_PLAN.md) sprint 02 |
| **C-25** | `log-serializers.ts` promis, jamais spécifié | **À spécifier** — ticket EVT-011 | [`SPRINT_PLAN.md`](sprints/SPRINT_PLAN.md) sprint 02 |
